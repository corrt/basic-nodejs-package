...
module.exports = [
  {
    ...
    output: {
      ...
      libraryTarget: 'umd',
      library: 'basic-nodejs-package',
      filename: 'basic-nodejs-package-webtest-int.js'
    },
    devServer: {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        filename: 'basic-nodejs-package-webtest-int.html',
        template: 'test/int/template-test.html',
        title: 'Mocha Integration Tests for basic-nodejs-package.js (from template)',
        minify: false,
        inject: false,
        hash: true
      })
