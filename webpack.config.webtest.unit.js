...
module.exports = [
  {
    ...
    output: {
      ...
      filename: 'basic-nodejs-package-webtest-unit.js'
    },
    devServer: {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        filename: 'basic-nodejs-package-webtest-unit.html',
        template: 'test/unit/template-test.html',
        title: 'Mocha Unit Tests for basic-nodejs-package (from template)',
        minify: false,
        inject: false,
        hash: true
      })
